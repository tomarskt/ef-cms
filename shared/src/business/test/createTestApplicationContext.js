...
const createTestApplicationContext = ({ user } = {}) => {
  ...
  const mockGetUseCasesReturnValue = {
    addCaseToTrialSessionInteractor: () => null,
    addConsolidatedCaseInteractor: () => null,
    addCoversheetInteractor: () => null,
    archiveDraftDocumentInteractor: () => null,
    assignWorkItemsInteractor: () => null,
    associateIrsPractitionerWithCaseInteractor: () => null,
    associatePrivatePractitionerWithCaseInteractor: () => null,
    caseAdvancedSearchInteractor: () => null,
    casePublicSearchInteractor: () => null,
    completeDocketEntryQCInteractor: () => null,
    createCaseDeadlineInteractor: () => null,
    createCourtIssuedOrderPdfFromHtmlInteractor: () => null,
    deleteCaseNoteInteractor: () => null,
    deleteCounselFromCaseInteractor: () => null,
    fetchPendingItemsInteractor: () => null,
    fileCourtIssuedDocketEntryInteractor: () => null,
    fileCourtIssuedOrderInteractor: () => null,
    fileDocketEntryInteractor: () => null,
    fileExternalDocumentForConsolidatedInteractor: () => null,
    fileExternalDocumentInteractor: () => null,
    generateCourtIssuedDocumentTitleInteractor: () => null,
    generateDocumentTitleInteractor: () => null,
    generatePdfFromHtmlInteractor: () => null,
    generatePrintableCaseInventoryReportInteractor: () => null,
    generatePrintableFilingReceiptInteractor: () => null,
    generatePublicDocketRecordPdfInteractor: () => null,
    getAllCaseDeadlinesInteractor: () => null,
    getBlockedCasesInteractor: () => null,
    getCalendaredCasesForTrialSessionInteractor: () => null,
    getCaseDeadlinesForCaseInteractor: () => null,
